# Play Store — Store-Eintrag (Entwurf)

Text zum Kopieren in Play Console → **Store-Präsenz → Haupt-Store-Eintrag**.

## Kurzbeschreibung (max. 80 Zeichen)

```
Ernährung & Training tracken – lokal, ohne Konto, ohne Werbung.
```
...
```
Trainist ist eine ruhige, werbefreie App für Ernährungs- und Trainingstracking – ganz ohne Konto, ganz ohne Cloud. Alle Daten bleiben auf deinem Gerät.
...
lammy.google.develop.flatness494@passmail.net

## Assets

- Hi-res-Icon (512×512, kein Alphakanal): [`icon-512.png`](./icon-512.png)
- Feature-Graphic (1024×500) und Screenshots fehlen noch — nicht Teil dieses Entwurfs.
