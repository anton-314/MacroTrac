        ...
        Column(
            ...
            DataCard(
                ...
                Button(
                    ...
                    Text("Vollständiges Backup exportieren", style = MaterialTheme.typography.labelLarge)
                }
            }
            ...
            DataCard(
                ...
                OutlinedButton(
                    ...
                    Text("Backup auswählen", style = MaterialTheme.typography.labelLarge)
                }
            }
...
/** Flat "Ink & Paper" card: surface fill, hairline border, no elevation. */
@Composable
